  ...
  loginArea.addEventListener('click',function(){
    ...
    const emailInput = document.getElementById('mail-btn');
    const email = emailInput.value;
    const passewordInput = document.getElementById('pass-btn');
    const password = passewordInput.value;
    if(email == 'sadiq@gmail.com' && password == 'sadiq')
    {
      ...
      alert ('Pless Enter your rigth email and pass')
